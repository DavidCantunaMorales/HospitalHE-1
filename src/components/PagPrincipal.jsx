  ...
  export const PagPrincipal = () => {
    const registrosEjemplo = [
      ...
      },
      {
        ...
        apellidoMaterno: 'RASTIDAS',
        primerNombre: 'CARLOS',
        segundoNombre: 'EMILIO',
        edad: 32,
        sexo: 'M',
        fechaIngreso: '15/12/2024 07:30',
      },
      {
        servicio: 'Emergencia',
        hab: 'EMER',
        ...
        segundoNombre: 'ALEXANDRA',
        edad: 50,
        sexo: 'F',
        fechaIngreso: '15/12/2024 07:25',
      },
      {
        servicio: 'Consulta Externa',
        hab: '10203',
        piso: 'Piso 2',
        hc: '41619',
        apellidoPaterno: 'PANGOL',
        apellidoMaterno: 'BUSTAMANTE',
        primerNombre: 'JULIA',
        segundoNombre: 'EVANGELINA',
        edad: 40,
        sexo: 'F',
        fechaIngreso: '15/12/2024 07:35',
      },
    ];
